...
public class TestsOrderList {
    ...
    public void prepareTestData() {
        ...
        List<Ingredient> ingredients = response.body().as(ResponseIngredients.class).getData();
    ...
    public void getOrderListWithAuthIsSuccess() {
        ...
        Response response1 = orderApi.getOrderList(token);
        baseApi.checkStatusCode(response1, 200);
        baseApi.checkLabelSuccess(response1, "true");
    }
    @Test
